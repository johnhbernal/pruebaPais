...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2017 a las 20:01:10
...
INSERT INTO `patients` (`patient_id`, `patient_name`, `patient_phone`, `patient_age`, `favorite_song_id`) VALUES
...
--
ALTER TABLE `patients`
  MODIFY `patient_id` bigint(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
